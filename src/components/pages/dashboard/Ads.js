...
import { clearErrors, deleteAdAsync, readAllAdsAsync } from "../../../features/ad/adSlice";
  ...
  return (
    <>
      ...
      <FormModal
        ...
        Form={AdForm}
        title={model ? "Update ad" : "Add new ad"}
        model={model}
      />
      <DeleteConfirmationModal
        ...
        deleteAsync={() => {
          dispatch(deleteAdAsync({ ad: model })).then(action => {
            if (!action.error) {
